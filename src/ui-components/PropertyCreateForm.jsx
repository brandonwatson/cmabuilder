...
export default function PropertyCreateForm(props) {
  ...
  const resetStateValues = () => {
    ...
    setNum_beds(initialValues.num_beds);
    setNum_bath(initialValues.num_bath);
    setTotal_sqft(initialValues.total_sqft);
    setAbove_grade_sqft(initialValues.above_grade_sqft);
    setUpper_sqft(initialValues.upper_sqft);
    setMain_sqft(initialValues.main_sqft);
    setFininshed_basement_sqft(initialValues.fininshed_basement_sqft);
    setUnfininshed_basement_sqft(initialValues.unfininshed_basement_sqft);
    setList_price(initialValues.list_price);
